...
- **Аккаунт администратора:** для смены статуса заказа. Логин обязательно при регистрации админа должен быть обязательно: admin и пароль: -----. Сейчас пароль - adminzero1.
## Технологии
